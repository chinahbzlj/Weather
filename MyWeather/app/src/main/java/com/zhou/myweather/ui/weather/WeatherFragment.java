...
import com.zhou.myweather.ui.TestActivity;
import com.zhou.myweather.ui.main.MyViewPager;
import com.zhou.myweather.ui.weather.adapter.MyFragmentAdapter;
import com.zhou.myweather.ui.weather.presenter.WeatherFragmentPresenterImpl;
...
//            startActivityForResult(new Intent(getActivity(), AddCityActivity.class), 1001);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1001) {
            ...
            List<LocalCityInfoMO> localCityInfoMOs = (List<LocalCityInfoMO>) bundle.get("citys");
