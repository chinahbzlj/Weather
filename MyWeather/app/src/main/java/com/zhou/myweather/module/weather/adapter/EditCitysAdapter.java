 ...
 */
public class EditCitysAdapter {
//    extends
//} BaseRecycleViewAdapter<EditCitysAdapter.ViewHolder> implements CompoundButton.OnCheckedChangeListener {
//
...
//        this.cityDatas = new ArrayList<CityData>();
...
//        List<LocalCityInfoMO> cityInfoMOs = new ArrayList<LocalCityInfoMO>();
